...
private:
    ...
    string _PrepareLogInRecord(string Seperator = "#//#")
    {
        ...
        LoginRecord += clsUtil::EncryptText (Password) + Seperator; //here we encypt store the encrypted Password not the real one(Extension 09)
    ...
    static string _ConverUserObjectToLine(clsUser User, string Seperator = "#//#")
    {
        ...
        UserRecord += clsUtil::EncryptText(User.Password) + Seperator;//here we encypt store the encrypted Password not the real one
